...
**Não há dados históricos directamente da Protecção Civil após 05/Julho/2020, sendo apenas mostradas no website as ocorrências do momento.**

Fontes: [website](http://www.prociv.pt/) da Autoridade Nacional da Proteção Civil
...
2020: ```91.528 ocorrências```  (somente até 05/07/2020)  
